...
namespace ADTO.DCloud.Migrations
{
    ...
    [Migration("20260422060612_20260422-lw-1")]
    partial class _20260422lw1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ADTO.DCloud.Attendances.AttendanceLog", b =>
                {
                    ...
                    b.Property<Guid?>("AMInLocationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("AMOutLocationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("PMInLocationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("PMOutLocationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ADTO.DCloud.Attendances.AttendanceTimeRule", b =>
                {
                    ...
                    b.Property<string>("AttendanceTimeIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ADTO.DCloud.ExcelManager.ExcelExportField", b =>
                {
                    ...
                    b.Property<string>("FormatConfig")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ADTO.DCloud.ExcelManager.ExcelImportField", b =>
                {
                    ...
                    b.Property<string>("RelationEntity")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ADTO.DCloud.Storage.SharedFileAuthorizes", b =>
                {
                    ...
                    b.Property<Guid>("SharedFileCategory")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ADTO.DCloud.Surveys.Survey", b =>
                {
                    ...
                    b.Property<decimal>("AnswerQuestionScore")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ChoiceQuestionScore")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("FillQuestionScore")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<decimal>("IsQuestionScore")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ADTO.DCloud.Surveys.SurveyAnswer", b =>
                {
                    ...
                    b.Property<DateTime?>("AnswerEndTime")
                        .HasColumnType("datetime2");

                    b.Property<int>("AnswerQuestionAmount")
                        .HasColumnType("int");

                    b.Property<DateTime?>("AnswerStartTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("SpendMinutes")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("ADTO.DCloud.Training.EmployeesTrainingArchives", b =>
                {
                    ...
                    b.Property<decimal>("TrainingHour")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("TrainingScore")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ADTO.DCloud.ExcelManager.ExcelExportField", b =>
                {
                    b.HasOne("ADTO.DCloud.ExcelManager.ExcelExport", "Export")
                        .WithMany()
            ...
            modelBuilder.Entity("ADTO.DCloud.Storage.SharedFileCategory", b =>
                {
                    b.HasOne("ADTO.DCloud.Storage.SharedFileCategory", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("ADTO.DCloud.Storage.SharedFileInfo", b =>
                {
                    b.HasOne("ADTO.DCloud.Storage.SharedFileCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId");
            ...
            modelBuilder.Entity("ADTO.DCloud.Training.TrainingDoc", b =>
                {
                    b.HasOne("ADTO.DCloud.Training.TrainingDocCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId");
