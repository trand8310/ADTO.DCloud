...
public class DCloudAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
{
    //private OpenIdConnectConfiguration? _configuration;

    /// <summary>
    /// Initializes a new instance of <see cref="DCloudAsyncJwtBearerHandler"/>.
    /// </summary>
    /// <inheritdoc />
    [Obsolete("ISystemClock is obsolete, use TimeProvider on AuthenticationSchemeOptions instead.")]
    public DCloudAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
    ...
    /// </summary>
    /// <inheritdoc />
    public DCloudAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options, ILoggerFactory logger, UrlEncoder encoder)
