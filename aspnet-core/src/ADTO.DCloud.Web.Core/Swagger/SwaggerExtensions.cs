...
namespace ADTO.DCloud.Web.Swagger;

public static class SwaggerExtensions
{
    /// <summary>
    /// Injects ADTOSharp base URI into the index.html page
    /// </summary>
    ...
    public static void InjectBaseUrl(this SwaggerUIOptions options, string pathBase)
    {
        ...
        options.HeadContent = new StringBuilder(options.HeadContent)
            .AppendLine($"<script> var adtosharp = adtosharp || {{}}; adtosharp.appPath = adtosharp.appPath || '{pathBase}'; </script>")
            .ToString();
    }
