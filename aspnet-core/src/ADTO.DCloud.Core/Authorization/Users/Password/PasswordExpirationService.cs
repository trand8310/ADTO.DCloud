...
/// 密码失效服务
/// </summary>
public class PasswordExpirationService : DCloudDomainServiceBase, IPasswordExpirationService
{
    ...
    private void ForcePasswordExpiredUsersToChangeTheirPasswordInternal(Guid? tenantId)
    {
