...
{
    public class ChatFeatureChecker : DCloudDomainServiceBase, IChatFeatureChecker
    {
        ...
        private void CheckChatFeaturesInternal(Guid? sourceTenantId, Guid? targetTenantId, ChatSide side)
        {
