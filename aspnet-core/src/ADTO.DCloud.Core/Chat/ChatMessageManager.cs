...
{
    [ADTOSharpAuthorize]
    public class ChatMessageManager : DCloudDomainServiceBase, IChatMessageManager
    {
        ...
        public async Task<ChatMessage> FindMessageAsync(long id, Guid userId)
        {
        ...
        private async Task<string> GetTenancyNameOrNull(Guid? tenantId)
        {
