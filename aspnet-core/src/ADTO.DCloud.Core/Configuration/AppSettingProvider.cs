...
namespace ADTO.DCloud.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            ...
            context.Manager.GetSettingDefinition(ADTOSharpZeroSettingNames.UserManagement.TwoFactorLogin.IsEnabled)
        ...
        {
            if (!DCloudConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[]
            {
                ...
                //小程序控制面板菜单
                new SettingDefinition(AppSettings.UserManagement.MiniProgram.WorkPanelMenu,
                    GetFromAppSettings(AppSettings.UserManagement.MiniProgram.WorkPanelMenu, ""),
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        DCloudConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
