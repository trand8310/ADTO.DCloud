namespace ADTO.DCloud.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        public static class UserManagement
        {
            ...
            {
                public const string WorkPanelMenu = "App.UserManagement.MiniProgram.WorkPanelMenu";
            }
        }
        ...
        public static class ExternalLoginProvider
        {
            ...
            {
                public const string WeixinMiniProgram = "ExternalLoginProvider.WeixinMiniProgram";
            ...
            {
                public const string WeixinMiniProgram = "ExternalLoginProvider.WeixinMiniProgram.Tenant";
                public const string WeixinMiniProgram_IsDeactivated = "ExternalLoginProvider.WeixinMiniProgram.IsDeactivated";
