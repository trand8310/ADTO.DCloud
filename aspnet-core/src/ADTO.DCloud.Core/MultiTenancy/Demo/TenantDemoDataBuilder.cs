...
namespace ADTO.DCloud.MultiTenancy.Demo
{
    ...
    /// </summary>
    public class TenantDemoDataBuilder : DCloudServiceBase, ITransientDependency
    {
        ...
        {
            var organizationUnit = new OrganizationUnit(tenant.Id, displayName, parent == null ? (Guid?)null : parent.Id);
