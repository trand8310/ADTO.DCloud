...
using ADTO.DCloud.MultiTenancy.Demo;
...
{
    public class TenantManager : ADTOSharpTenantManager<Tenant, User>
    {
        ...
        private readonly IADTOSharpZeroDbMigrator _adtosharpZeroDbMigrator;
        private readonly IPasswordHasher<User> _passwordHasher;
        private readonly IRepository<SubscribableEdition, Guid> _subscribableEditionRepository;
        ...
        public TenantManager(
            ...
            IADTOSharpZeroDbMigrator adtosharpZeroDbMigrator,
            IPasswordHasher<User> passwordHasher,
            IRepository<SubscribableEdition, Guid> subscribableEditionRepository,
        ...
        )
        {
            ...
            _adtosharpZeroDbMigrator = adtosharpZeroDbMigrator;
            _passwordHasher = passwordHasher;
            _subscribableEditionRepository = subscribableEditionRepository;
            _backgroundJobManager = backgroundJobManager;
        }

        public async Task<Guid> CreateWithAdminUserAsync(
            string tenancyName,
            string name,
        ...
        )
        {
            ...
            if (isInTrialPeriod && !subscriptionEndDate.HasValue)
            {
                throw new UserFriendlyException(LocalizationManager.GetString(
                    DCloudConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
            ...
            using (var uow = _unitOfWorkManager.Begin(TransactionScopeOption.RequiresNew))
            {
                ...
                _adtosharpZeroDbMigrator.CreateOrMigrateForTenant(tenant);
                ...
                using (_unitOfWorkManager.Current.SetTenantId(tenant.Id))
                {
                    ...
                    var adminUser = User.CreateTenantAdminUser(tenant.Id, adminEmailAddress, adminName);
                    ...
                    {
                        await _userManager.InitializeOptionsAsync(ADTOSharpSession.TenantId);
                    ...
                    await _backgroundJobManager.EnqueueAsync<TenantDemoDataBuilderJob, Guid>(tenant.Id);
        ...
        public async Task CheckEditionAsync(Guid? editionId, bool isInTrialPeriod)
        {
            await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                ...
                var error = LocalizationManager.GetSource(DCloudConsts.LocalizationSourceName)
