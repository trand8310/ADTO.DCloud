...
{
    public class StripeGatewayManager:DCloudServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ADTO.DCloud";
        ...
        public async Task UpdateSubscription(Guid newEditionId, Guid tenantId, bool isProrateCharged = false)
        {
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + DCloudConsts.Currency;
        }
        ...
        private SubscriptionPayment GetLastCompletedSubscriptionPayment(Guid tenantId)
        {
            ...
            string productId)
        {
            ...
            var plan = await planService.CreateAsync(new PlanCreateOptions
            {
                ...
                Interval = interval,
                Product = productId,
                Currency = DCloudConsts.Currency
            });
