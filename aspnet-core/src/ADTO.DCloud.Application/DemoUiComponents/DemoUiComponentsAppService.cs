...
{
    [HiddenApi,ADTOSharpAuthorize(PermissionNames.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : DCloudAppServiceBase, IDemoUiComponentsAppService
    {
