...
public class PropertyInfoHelper : IPropertyInfoHelper
{
    ...
    public PropertyInfoHelper(IADTOSharpSession session, ITimeZoneConverter timeZoneConverter)
    {
        _session = session;
        ...
        switch (typeCode)
        {
            case TypeCode.DateTime:
                ...
                if (propertyType == typeof(DateTime))
                {
                    ...
                    return _timeZoneConverter.Convert((DateTime)value, _session.TenantId, _session.GetUserId());
                }
