...
namespace ADTO.DCloud.Authorization.Permissions
{
    public static class PermissionManagerExtensions
    {
        ...
        /// Throws <see cref="ADTOSharpValidationException"/> if can not find any of the permission names.
        /// </summary>
        public static IEnumerable<Permission> GetPermissionsFromNamesByValidating(this IPermissionManager permissionManager, IEnumerable<string> permissionNames)
        {
            ...
            {
                throw new ADTOSharpValidationException($"There are {undefinedPermissionNames.Count} undefined permission names.")
                      {
