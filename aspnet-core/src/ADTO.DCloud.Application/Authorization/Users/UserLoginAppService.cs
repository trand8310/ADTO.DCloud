...
/// <summary>
/// 用户登录服务,管理使用第三方登录时产生的登录信息,后台可以清除这些记录,
/// </summary>
[ADTOSharpAuthorize]
public class UserLoginAppService : DCloudAppServiceBase, IUserLoginAppService
{
    private readonly IRepository<UserLoginAttempt, Guid> _userLoginAttemptRepository;

    public UserLoginAppService(IRepository<UserLoginAttempt, Guid> userLoginAttemptRepository)
    {
