...
namespace ADTO.DCloud.UiCustomization
{
    public interface IUiCustomizer : ISingletonDependency
    {
        ...
        Task UpdateTenantUiManagementSettingsAsync(Guid tenantId, ThemeSettingsDto settings, UserIdentifier changerUser);
        ...
        Task<ThemeSettingsDto> GetTenantUiCustomizationSettings(Guid tenantId);
