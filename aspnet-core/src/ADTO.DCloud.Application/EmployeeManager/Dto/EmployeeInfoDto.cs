...
namespace ADTO.DCloud.EmployeeManager.Dto
{
    ...
    public class EmployeeInfoDto : FullAuditedEntityDto<Guid>
    {
        /// <summary>
        /// 用户信息
        /// </summary>
        ...
        /// <summary>
        /// 是否考勤-文本（0：双休打卡/1：单休打卡/2：排班打卡/3：不打卡）
        /// </summary>	
        public string IsAttTypeText { get; set; }
        /// <summary>
        /// 允许APP打卡
        /// </summary>	
        ...
        /// （考勤时间）-对应之前的考勤区域
        /// </summary>	
        public string AttTimeRule{ get; set; }
        /// <summary>
        /// 入职日期
        /// </summary>
