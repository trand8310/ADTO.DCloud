...
{
    [HiddenApi]
    public class StripePaymentAppService : DCloudAppServiceBase, IStripePaymentAppService
    {
        ...
        private async Task ConfirmSubscriptionUpgradeProrationPayment(Guid newEditionId, Guid tenantId)
        {
