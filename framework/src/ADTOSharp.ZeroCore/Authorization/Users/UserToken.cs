...
public class UserToken : Entity<Guid>, IMayHaveTenant
{
    ...
    protected internal UserToken(ADTOSharpUserBase user, [NotNull] string loginProvider, [NotNull] string name, string value, DateTime? expireDate = null)
    {
