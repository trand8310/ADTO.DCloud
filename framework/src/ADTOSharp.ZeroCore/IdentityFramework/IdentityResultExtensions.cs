...
using ADTOSharp.Text;
using ADTOSharp.UI;
using ADTOSharp.Zero;
using Microsoft.AspNetCore.Identity;

namespace ADTOSharp.IdentityFramework;
...
public static class IdentityResultExtensions
{
    ...
    {
        return LocalizeErrors(identityResult, localizationManager, ADTOSharpZeroConsts.LocalizationSourceName);
    }
