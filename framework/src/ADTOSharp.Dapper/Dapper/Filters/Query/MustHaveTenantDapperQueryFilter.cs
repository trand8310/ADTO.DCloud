    ...
    public class MustHaveTenantDapperQueryFilter : IDapperQueryFilter
    {
        ...
        private Guid TenantId
        {
            get
            {
                ...
                if (filter.FilterParameters.ContainsKey(ADTOSharpDataFilters.Parameters.TenantId))
                {
                    return (Guid)filter.FilterParameters[ADTOSharpDataFilters.Parameters.TenantId];
                }
        ...
        public string FilterName { get; } = ADTOSharpDataFilters.MustHaveTenant;
