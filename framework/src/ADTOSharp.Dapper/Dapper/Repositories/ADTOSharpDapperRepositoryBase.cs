...
namespace ADTOSharp.Dapper.Repositories
{
    ...
    public abstract class ADTOSharpDapperRepositoryBase<TEntity, TPrimaryKey> : IDapperRepository<TEntity, TPrimaryKey> where TEntity : class, IEntity<TPrimaryKey>
    {
        public static MultiTenancySides? MultiTenancySide { get; private set; }

        static ADTOSharpDapperRepositoryBase()
        {
