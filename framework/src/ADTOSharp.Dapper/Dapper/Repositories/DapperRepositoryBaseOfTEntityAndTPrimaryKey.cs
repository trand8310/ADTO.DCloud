...
using ADTOSharp.Dapper.Extensions;
using ADTOSharp.Dapper.Filters.Action;
using ADTOSharp.Dapper.Filters.Query;
...
{
    public class DapperRepositoryBase<TEntity, TPrimaryKey> : ADTOSharpDapperRepositoryBase<TEntity, TPrimaryKey>
