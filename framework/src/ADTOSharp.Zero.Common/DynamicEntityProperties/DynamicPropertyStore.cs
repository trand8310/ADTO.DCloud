...
namespace ADTOSharp.DynamicEntityProperties
{
    ...
    {
        private readonly IRepository<DynamicProperty, Guid> _dynamicPropertyRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public DynamicPropertyStore(
            IRepository<DynamicProperty,Guid> dynamicPropertyRepository,
        ...
        public virtual async Task<DynamicProperty> GetAsync(Guid id)
        {
