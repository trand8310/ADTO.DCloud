...
namespace ADTOSharp.DynamicEntityProperties
{
    ...
    {
        private readonly IRepository<DynamicEntityProperty,Guid> _dynamicEntityPropertyRepository;
        private readonly IAsyncQueryableExecuter _asyncQueryableExecuter;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public DynamicEntityPropertyStore(
            IRepository<DynamicEntityProperty, Guid> dynamicEntityPropertyRepository,
