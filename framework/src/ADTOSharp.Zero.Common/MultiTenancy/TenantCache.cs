...
namespace ADTOSharp.MultiTenancy
{
        ...
        where TUser : ADTOSharpUserBase
    {
        ...
        public virtual TenantCacheItem Get(Guid tenantId)
        {
            ...
            if (cacheItem == null)
            {
                throw new ADTOSharpException("There is no tenant with given id: " + tenantId);
            }
        ...
        public virtual TenantCacheItem Get(string tenancyName)
        {
            ...
            if (cacheItem == null)
            {
                throw new ADTOSharpException("There is no tenant with given tenancy name: " + tenancyName);
            }
