...
public class LocalADTODistributedLock : IADTODistributedLock, ISingletonDependency
{
    ...
    public LocalADTODistributedLock(IDistributedLockKeyNormalizer distributedLockKeyNormalizer)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return new LocalADTODistributedLockHandle(timeoutReleaser);
        }
        return null;
    }
}
