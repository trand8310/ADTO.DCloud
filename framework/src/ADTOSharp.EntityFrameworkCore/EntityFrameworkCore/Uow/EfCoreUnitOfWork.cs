...
namespace ADTOSharp.EntityFrameworkCore.Uow;
...
public class EfCoreUnitOfWork : UnitOfWorkBase, ITransientDependency
{
        ...
        where TDbContext : DbContext
    {
        ...
        if (dbContext is IShouldInitializeDcontext efDbContext)
        {
            efDbContext.Initialize(new ADTOSharpEfDbContextInitializationContext(this));
        }
