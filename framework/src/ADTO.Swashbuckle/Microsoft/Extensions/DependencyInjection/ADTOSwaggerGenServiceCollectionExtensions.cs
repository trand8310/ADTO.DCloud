...
public static class ADTOSwaggerGenServiceCollectionExtensions
{
    public static IServiceCollection AddADTOSwaggerGen(
    ...
    public static IServiceCollection AddADTOSwaggerGenWithOAuth(
        this IServiceCollection services,
    ...
    public static IServiceCollection AddADTOSwaggerGenWithOidc(
        this IServiceCollection services,
        [NotNull] string authority,
        string[]? scopes = null,
        string[]? flows = null,
        ...
        Action<SwaggerGenOptions>? setupAction = null)
    {
        ...
        flows ??= new [] { ADTOSwaggerOidcFlows.AuthorizationCode };
