...
public abstract class OnlineClientHubBase : ADTOSharpHubBase, ITransientDependency
{
    protected IOnlineClientManager OnlineClientManager { get; }
    protected IOnlineClientInfoProvider OnlineClientInfoProvider { get; }

    /// <summary>
    /// Initializes a new instance of the <see cref="ADTOSharpCommonHub"/> class.
    /// </summary>
...
#pragma warning disable CS0618 // Type or member is obsolete, this line will be removed once the ADTOSharpSession property is removed
        ADTOSharpSession = NullADTOSharpSession.Instance;
#pragma warning restore CS0618 // Type or member is obsolete, this line will be removed once the ADTOSharpSession property is removed
    }
