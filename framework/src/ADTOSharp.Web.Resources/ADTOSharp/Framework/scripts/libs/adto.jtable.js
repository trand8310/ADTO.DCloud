...
(function ($) {
    ...
    $.extend(true, $.hik.jtable.prototype, {
        ...
        //Override _create function to change actions according to ADTOSharp system
        _create: function () {
            var self = this;
            base._create.apply(self, arguments);

            if (self.options.actions.listAction) {
                self._adaptListActionforADTOSharp();
            }

            if (self.options.actions.createAction) {
                self._adaptCreateActionforADTOSharp();
            }

            if (self.options.actions.updateAction) {
                self._adaptUpdateActionforADTOSharp();
            }

            if (self.options.actions.deleteAction) {
                self._adaptDeleteActionforADTOSharp();
            }
        },

        //LIST ACTION ADAPTER
        _adaptListActionforADTOSharp: function () {
            var self = this;
            ...
            self.options.actions.listAction = function (postData, jtParams) {
                return $.Deferred(function ($dfd) {
                    ...
                    originalListAction.method(input)
                        ...
                        .fail(function (error) {
                            self._handlerForFailOnADTOSharpRequest($dfd, error);
                        });
                });
            };
        },
        ...
        _adaptCreateActionforADTOSharp: function () {
            var self = this;
        ...
        _adaptUpdateActionforADTOSharp: function () {
            var self = this;
        ...
        _adaptDeleteActionforADTOSharp: function () {
            var self = this;
        ...
        _handlerForFailOnADTOSharpRequest: function ($dfd, error) {
        ...
        _showError: function (message) {
            //do nothing since ADTOSharp handles error messages!
        }
