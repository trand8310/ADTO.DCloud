...
namespace ADTOSharp.Runtime.Caching.Redis
{
    ...
    /// </summary>
    public class ADTOSharpRedisCache : CacheBase
    {
        private readonly IDatabase _database;
        private readonly IRedisCacheSerializer _serializer;

        protected IADTOSharpRedisCacheKeyNormalizer KeyNormalizer { get; }
        protected IMultiTenancyConfig MultiTenancyConfig { get; }

        /// <summary>
        /// Constructor.
        /// </summary>
        public ADTOSharpRedisCache(
            string name,
            IADTOSharpRedisCacheDatabaseProvider redisCacheDatabaseProvider,
            IRedisCacheSerializer redisCacheSerializer,
            IADTOSharpRedisCacheKeyNormalizer keyNormalizer,
        ...
        protected virtual RedisKey NormalizeKey(string key)
        {
            return KeyNormalizer.NormalizeKey(
                new ADTOSharpRedisCacheKeyNormalizeArgs(
                    key,
                    Name,
        ...
        protected virtual Type GetSerializableType(object value)
        {
            ...
            //TODO: Normally, entities should not be stored in the cache, but currently ADTOSharp.Zero packages does it. It will be fixed in the future.
