...
namespace ADTOSharp.Web.Navigation
{
    internal class NavigationScriptManager : INavigationScriptManager, ITransientDependency
    {
        ...
        {
            var userMenus = await _userNavigationManager.GetMenusAsync(ADTOSharpSession.ToUserIdentifier());

            var script = new StringBuilder();
            script.AppendLine("(function() {");

            script.AppendLine("    adto.nav = {};");
            script.AppendLine("    adto.nav.menus = {");
