...
namespace ADTOSharp.Web.Api.ProxyScripting.Generators.JQuery
{
    public class JQueryProxyScriptGenerator : IProxyScriptGenerator, ITransientDependency
    {
        ...
        public string CreateScript(ApplicationApiDescriptionModel model)
        {
            ...
            script.AppendLine("/* This file is automatically generated by ADTO framework to use MVC Controllers from JavaScript. */");
            script.AppendLine();
            script.AppendLine("var adto = adto || {};");
            script.AppendLine("adto.services = adto.services || {};");
        ...
        private static void AddModuleScript(StringBuilder script, ModuleApiDescriptionModel module)
        {
            ...
            script.AppendLine();
            script.AppendLine($"  adto.services.{module.Name.ToCamelCase()} = adto.services.{module.Name.ToCamelCase()} || {{}};");
        ...
        private static void AddControllerScript(StringBuilder script, ModuleApiDescriptionModel module, ControllerApiDescriptionModel controller)
        {
            ...
            script.AppendLine($"    adto.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()} = adto.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()} || {{}};");
        ...
        private static void AddActionScript(StringBuilder script, ModuleApiDescriptionModel module, ControllerApiDescriptionModel controller, ActionApiDescriptionModel action)
        {
            ...
            script.AppendLine($"    adto.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()}{ProxyScriptingJsFuncHelper.WrapWithBracketsOrWithDotPrefix(action.Name.ToCamelCase())} = function({parameterList}) {{");
            script.AppendLine("      return adto.ajax($.extend(true, {");
        ...
        private static void AddAjaxCallParameters(StringBuilder script, ControllerApiDescriptionModel controller, ActionApiDescriptionModel action)
        {
            ...
            script.AppendLine("        url: adto.appPath + '" + ProxyScriptingHelper.GenerateUrlWithParameters(action) + "',");
