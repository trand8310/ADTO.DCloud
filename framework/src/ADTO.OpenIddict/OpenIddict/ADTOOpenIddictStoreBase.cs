...
public abstract class ADTOOpenIddictStoreBase<TRepository>
    where TRepository : IRepository
{
    public ILogger<ADTOOpenIddictStoreBase<TRepository>> Logger { get; set; }
    ...
    protected ADTOOpenIddictStoreBase(
        ...
        IOpenIddictDbConcurrencyExceptionHandler concurrencyExceptionHandler)
    {
        ...
        Logger = NullLogger<ADTOOpenIddictStoreBase<TRepository>>.Instance;
    }
