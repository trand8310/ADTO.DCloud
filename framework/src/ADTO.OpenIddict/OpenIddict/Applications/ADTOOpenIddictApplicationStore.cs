...
public class ADTOOpenIddictApplicationStore : ADTOOpenIddictStoreBase<IOpenIddictApplicationRepository>,
    IADTOOpenIdApplicationStore
{
    protected IOpenIddictTokenRepository TokenRepository { get; }

    public ADTOOpenIddictApplicationStore(
    ...
    public virtual async ValueTask DeleteAsync(OpenIddictApplicationModel application, CancellationToken cancellationToken)
    {
        ...
        catch (ADTOSharpDbConcurrencyException e)
        {
