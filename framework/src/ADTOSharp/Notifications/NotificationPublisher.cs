...
namespace ADTOSharp.Notifications
{
    ...
    /// </summary>
    public class NotificationPublisher : ADTOSharpServiceBase, INotificationPublisher, ITransientDependency
    {
            ...
            Type[] targetNotifiers = null)
        {
            using (var uow = UnitOfWorkManager.Begin())
            {
                ...
                if (tenantIds.IsNullOrEmpty() && userIds.IsNullOrEmpty())
                {
                    tenantIds = new[] { ADTOSharpSession.TenantId };
                }
