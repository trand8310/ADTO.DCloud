...
namespace ADTOSharp.Notifications
{
    ...
    public interface INotificationStore
    {
        ...
        /// </summary>
        Task<List<NotificationSubscriptionInfo>> GetSubscriptionsAsync(Guid?[] tenantIds, string notificationName, string entityTypeName, string entityId, string targetNotifiers);

        /// <summary>
        /// Gets subscriptions for a notification for specified tenant(s).
        /// </summary>
        List<NotificationSubscriptionInfo> GetSubscriptions(Guid?[] tenantIds, string notificationName, string entityTypeName, string entityId, string targetNotifiers);
        ...
        Task<List<UserNotificationInfoWithNotificationInfo>> GetUserNotificationsWithNotificationsAsync(UserIdentifier user, UserNotificationState? state = null, int pageNumber = 0, int pageSize = int.MaxValue, DateTime? startDate = null, DateTime? endDate = null);
        ...
        /// <param name="startDate">List notifications published after startDateTime</param>
        /// <param name="endDate">List notifications published before startDateTime</param>
        List<UserNotificationInfoWithNotificationInfo> GetUserNotificationsWithNotifications(UserIdentifier user, UserNotificationState? state = null, int pageNumber = 0, int pageSize = int.MaxValue, DateTime? startDate = null, DateTime? endDate = null);
        ...
        Task<List<GetNotificationsCreatedByUserOutput>> GetNotificationsPublishedByTenantAsync(Guid? tenantId,
            string notificationName, DateTime? startDate, DateTime? endDate);
    }
}