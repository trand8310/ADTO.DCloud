...
namespace ADTOSharp.Notifications
{
    ...
    public interface IUserNotificationManager
    {
        ...
        Task<List<UserNotification>> GetUserNotificationsAsync(UserIdentifier user, UserNotificationState? state = null, int pageNumber = 0, int pageSize = int.MaxValue, DateTime? startDate = null, DateTime? endDate = null);
        ...
        /// <param name="startDate">List notifications published after startDateTime</param>
        /// <param name="endDate">List notifications published before startDateTime</param>
        List<UserNotification> GetUserNotifications(UserIdentifier user, UserNotificationState? state = null, int pageNumber = 0, int pageSize = int.MaxValue, DateTime? startDate = null, DateTime? endDate = null);
