...
namespace ADTOSharp.Notifications
{
    ...
    public interface INotificationSubscriptionManager
    {
        ...
        /// <param name="entityIdentifier">entity identifier</param>
        /// <param name="targetNotifiers">target notifier</param>
        Task<List<NotificationSubscription>> GetSubscriptionsAsync(Guid? tenantId, string notificationName, EntityIdentifier entityIdentifier = null, string targetNotifiers = null);
        ...
        /// <param name="entityIdentifier">entity identifier</param>
        /// <param name="targetNotifiers">target notifier</param>
        List<NotificationSubscription> GetSubscriptions(Guid? tenantId, string notificationName, EntityIdentifier entityIdentifier = null, string targetNotifiers = null);
