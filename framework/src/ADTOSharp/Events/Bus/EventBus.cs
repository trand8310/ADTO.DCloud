...
using ADTOSharp.Events.Bus.Factories;
using ADTOSharp.Events.Bus.Factories.Internals;
using ADTOSharp.Events.Bus.Handlers;
using ADTOSharp.Events.Bus.Handlers.Internals;
...
namespace ADTOSharp.Events.Bus
{
    /// <summary>
            ...
            foreach (var handlerFactories in GetHandlerFactories(eventType))
            {
                foreach (var handlerFactory in handlerFactories.EventHandlerFactories)
                {
                    ...
                    else
                    {
                        ...
                        exceptions.Add(new ADTOSharpException(message));
                    }
                }
            }
