...
{
    /// <summary>
    /// Used to store ADTOSharpModuleInfo objects as a dictionary.
    /// </summary>
    internal class ADTOSharpModuleCollection : List<ADTOSharpModuleInfo>
    {
        public Type StartupModuleType { get; }

        public ADTOSharpModuleCollection(Type startupModuleType)
        {
        ...
        public TModule GetModule<TModule>() where TModule : ADTOSharpModule
        {
            var module = this.FirstOrDefault(m => m.Type == typeof(TModule));
            if (module == null)
            {
                throw new ADTOSharpException("Can not find module for " + typeof(TModule).FullName);
            }
        ...
        public List<ADTOSharpModuleInfo> GetSortedModuleListByDependency()
        {
        ...
        public static void EnsureKernelModuleToBeFirst(List<ADTOSharpModuleInfo> modules)
        {
            var kernelModuleIndex = modules.FindIndex(m => m.Type == typeof(ADTOSharpKernelModule));
        ...
        public static void EnsureStartupModuleToBeLast(List<ADTOSharpModuleInfo> modules, Type startupModuleType)
        {
