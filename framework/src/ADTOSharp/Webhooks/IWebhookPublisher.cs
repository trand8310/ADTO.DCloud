...
namespace ADTOSharp.Webhooks
{
    ...
    {
        /// <summary>
        /// Sends webhooks to current tenant subscriptions (<see cref="IADTOSharpSession.TenantId"/>). with given data, (Checks permissions)
        /// </summary>
        ...
        /// </param>
        /// <param name="headers">Headers to send. Publisher uses subscription defined webhook by default. You can add additional headers from here. If subscription already has given header, publisher uses the one you give here.</param>
        void Publish(string webhookName, object data, Guid? tenantId, bool sendExactSameData = false, WebhookHeader headers = null);
        ...
        /// </param>
        /// <param name="headers">Headers to send. Publisher uses subscription defined webhook by default. You can add additional headers from here. If subscription already has given header, publisher uses the one you give here.</param>
        void Publish(Guid?[] tenantIds, string webhookName, object data, bool sendExactSameData = false, WebhookHeader headers = null);
    }
}