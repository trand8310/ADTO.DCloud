...
namespace ADTOSharp.Webhooks
{
    ...
    public class NullWebhookSubscriptionsStore : IWebhookSubscriptionsStore
    {
        ...
        public List<WebhookSubscriptionInfo> GetAllSubscriptionsOfTenants(Guid?[] tenantIds)
        {
            return new List<WebhookSubscriptionInfo>();
        }
        ...
        public List<WebhookSubscriptionInfo> GetAllSubscriptionsOfTenants(Guid?[] tenantIds, string webhookName)
        {
            return new List<WebhookSubscriptionInfo>();
        }
