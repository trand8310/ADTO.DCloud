...
namespace ADTOSharp.Net.Mail
{
    ...
    public abstract class EmailSenderConfiguration : IEmailSenderConfiguration
    {
        ...
        /// <summary>
        /// Gets a setting value by checking. Throws <see cref="ADTOSharpException"/> if it's null or empty.
        /// </summary>
        ...
        protected string GetNotEmptySettingValue(string name)
        {
            ...
            {
                throw new ADTOSharpException($"Setting value for '{name}' is null or empty!");
            }
