...
namespace ADTOSharp.Linq.Extensions
{
    /// <summary>
    ...
    public static class QueryableExtensions
    {
        ...
        public static IQueryable<T> PageBy<T>(this IQueryable<T> query, int pageNumber, int pageSize)
        {
            ...
            return query.Skip((pageNumber > 1 ? (pageNumber - 1) * pageSize : 0)).Take(pageSize);
        }
        ...
        {
            return query.PageBy(pagedResultRequest.PageNumber, pagedResultRequest.PageSize);
        }
