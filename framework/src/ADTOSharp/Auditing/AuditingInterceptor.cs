...
{
    internal class AuditingInterceptor : ADTOSharpInterceptorBase, ITransientDependency
    {
        ...
        {
            if (ADTOSharpCrossCuttingConcerns.IsApplied(invocation.InvocationTarget, ADTOSharpCrossCuttingConcerns.Auditing))
            {
                invocation.Proceed();
                return;
            }
