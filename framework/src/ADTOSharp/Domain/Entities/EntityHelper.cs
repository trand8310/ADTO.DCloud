...
namespace ADTOSharp.Domain.Entities
{
    ...
    public static class EntityHelper
    {
        ...
        public static Type GetPrimaryKeyType(Type entityType)
        {
            ...
            throw new ADTOSharpException("Can not find primary key type of given entity type: " + entityType + ". Be sure that this entity type implements IEntity<TPrimaryKey> interface");
        }
        ...
        public static object GetEntityId(object entity)
        {
            ...
            {
                throw new ADTOSharpException(entity.GetType() + " is not an Entity !");
            }
