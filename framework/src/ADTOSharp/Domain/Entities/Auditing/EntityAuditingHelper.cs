...
namespace ADTOSharp.Domain.Entities.Auditing
{
    public static class EntityAuditingHelper
    {
            ...
            IReadOnlyList<AuditFieldConfiguration> auditFields)
        {
            ...
            var creationUserIdFilter = auditFields?.FirstOrDefault(e => e.FieldName == ADTOSharpAuditFields.CreatorUserId);
                   ...
                   IReadOnlyList<AuditFieldConfiguration> auditFields)
        {
            ...
            {
                var lastModificationTimeFilter = auditFields?.FirstOrDefault(e => e.FieldName == ADTOSharpAuditFields.LastModificationTime);
            ...
            var lastModifierUserIdFilter = auditFields?.FirstOrDefault(e => e.FieldName == ADTOSharpAuditFields.LastModifierUserId);
            ...
            IReadOnlyList<AuditFieldConfiguration> auditFields)
        {
            if (entityAsObj is IHasDeletionTime)
            {
                ...
                {
                    var deletionTimeFilter = auditFields?.FirstOrDefault(e => e.FieldName == ADTOSharpAuditFields.DeletionTime);
            ...
            if (entityAsObj is IDeletionAudited)
            {
                ...
                var deleterUserIdFilter = auditFields?.FirstOrDefault(e => e.FieldName == ADTOSharpAuditFields.DeleterUserId);
