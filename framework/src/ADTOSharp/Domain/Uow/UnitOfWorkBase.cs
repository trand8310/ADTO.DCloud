...
namespace ADTOSharp.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// <summary>
        /// Reference to current ADTO session.
        /// </summary>
        public IADTOSharpSession ADTOSharpSession { protected get; set; }
        ...
        public void Begin(UnitOfWorkOptions options)
        {
            ...
            SetTenantId(ADTOSharpSession.TenantId, false);
        ...
        public virtual IDisposable SetTenantId(Guid? tenantId, bool switchMustHaveTenantEnableDisable)
        {
            ...
            if (switchMustHaveTenantEnableDisable)
            {
                mustHaveTenantEnableChange = tenantId == null
                    ? DisableFilter(ADTOSharpDataFilters.MustHaveTenant)
                    : EnableFilter(ADTOSharpDataFilters.MustHaveTenant);
            }
            else
            {
            ...
            var mayHaveTenantChange = SetFilterParameter(ADTOSharpDataFilters.MayHaveTenant, ADTOSharpDataFilters.Parameters.TenantId, tenantId);
            var mustHaveTenantChange = SetFilterParameter(ADTOSharpDataFilters.MustHaveTenant, ADTOSharpDataFilters.Parameters.TenantId, tenantId ?? Guid.Empty);
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new ADTOSharpException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new ADTOSharpException("Complete is called before!");
            }
        ...
        private void SetFilters(List<DataFilterConfiguration> filterOverrides)
        {
            ...
            {
                ChangeFilterIsEnabledIfNotOverrided(filterOverrides, ADTOSharpDataFilters.MustHaveTenant, false);
            }
        }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new ADTOSharpException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
