...
namespace ADTOSharp.Domain.Uow
{
    ...
    public interface IActiveUnitOfWork
    {
        ...
        /// </summary>
        /// <param name="filterNames">One or more filter names. <see cref="ADTOSharpDataFilters"/> for standard filters.</param>
        ...
        /// </summary>
        /// <param name="filterName">Name of the filter. <see cref="ADTOSharpDataFilters"/> for standard filters.</param>
        ...
        /// </summary>
        /// <param name="fieldNames">One or more audit field names. <see cref="ADTOSharpAuditFields"/> for standard fields.</param>
        /// <returns>A <see cref="IDisposable"/> handle to take back the disable effect.</returns>
