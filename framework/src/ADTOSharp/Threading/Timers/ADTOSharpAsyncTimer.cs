...
namespace ADTOSharp.Threading.Timers
{
    public class ADTOSharpAsyncTimer : RunnableBase, ITransientDependency
    {
        ...
        /// </summary>
        public Func<ADTOSharpAsyncTimer, Task> Elapsed = _ => Task.CompletedTask;
        ...
        public ADTOSharpAsyncTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new ADTOSharpException("Period should be set before starting the timer!");
            }
