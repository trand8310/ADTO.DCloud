...
namespace ADTOSharp.Localization.Dictionaries
{
    public abstract class LocalizationDictionaryProviderBase : ILocalizationDictionaryProvider
    {
            ...
            where TDictionary : ILocalizationDictionary
        {
            ...
            {
                throw new ADTOSharpInitializationException(SourceName + " source contains more than one dictionary for the culture: " + dictionary.CultureInfo.Name);
            }
            ...
            if (isDefault)
            {
                ...
                {
                    throw new ADTOSharpInitializationException("Only one default localization dictionary can be for source: " + SourceName);
                }
