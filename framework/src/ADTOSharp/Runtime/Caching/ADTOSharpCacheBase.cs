...
{
    /// <summary>
    /// Base class for caches with generic types, <see cref="ADTOSharpCacheBase{TKey, TValue}"/> and .
    /// It provides default implementation of <see cref="IADTOSharpCache{TKey, TValue}"/>.
    /// </summary>
    public abstract class ADTOSharpCacheBase<TKey, TValue> : ADTOSharpCacheBase, IADTOSharpCache<TKey, TValue>, ICacheOptions
    {
        ...
        protected ADTOSharpCacheBase(string name) : base(name)
        {
    ...
    /// </summary>
    public abstract class ADTOSharpCacheBase : IDisposable, IADTOSharpCache
    {
        ...
        /// </summary>
        /// <param name="name"></param>
        protected ADTOSharpCacheBase(string name)
        {
            Name = name;
