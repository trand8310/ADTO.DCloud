...
{
    public class ADTOSharpStringToEnumFactory : JsonConverterFactory
    {
        private readonly JsonNamingPolicy _namingPolicy;
        private readonly bool _allowIntegerValues;

        public ADTOSharpStringToEnumFactory()
            : this(namingPolicy: null, allowIntegerValues: true)
        {

        }

        public ADTOSharpStringToEnumFactory(JsonNamingPolicy namingPolicy, bool allowIntegerValues)
        {
        ...
        public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
        {
            return (JsonConverter)Activator.CreateInstance(
                typeof(ADTOSharpStringToEnumConverter<>).MakeGenericType(typeToConvert),
    ...
    public class ADTOSharpStringToEnumConverter<T> : JsonConverter<T>
        where T : struct, Enum
    {
        ...
        public ADTOSharpStringToEnumConverter()
            : this(namingPolicy: null, allowIntegerValues: true)
        {

        }

        public ADTOSharpStringToEnumConverter(JsonNamingPolicy namingPolicy = null, bool allowIntegerValues = true)
        {
        ...
        public override T Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            if (_readJsonSerializerOptions == null)
            {
                _readJsonSerializerOptions = JsonSerializerOptionsHelper.Create(options, x =>
                        x == this ||
                        x.GetType() == typeof(ADTOSharpStringToEnumFactory),
