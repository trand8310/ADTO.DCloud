...
namespace ADTOSharp.Json
{
    public static class JsonExtensions
    {
        ...
        private static readonly ADTOSharpCamelCasePropertyNamesContractResolver
            SharedADTOSharpCamelCasePropertyNamesContractResolver;

        private static readonly ADTOSharpContractResolver SharedADTOSharpContractResolver;
        private static readonly ConcurrentDictionary<object, JsonSerializerOptions> JsonSerializerOptionsCache;

        static JsonExtensions()
        {
            SharedADTOSharpCamelCasePropertyNamesContractResolver = new ADTOSharpCamelCasePropertyNamesContractResolver();
            SharedADTOSharpContractResolver = new ADTOSharpContractResolver();
        ...
        private static string ToJsonStringWithNewtonsoft(this object obj, bool camelCase = false, bool indented = false)
        {
            ...
            if (camelCase)
            {
                settings.ContractResolver = SharedADTOSharpCamelCasePropertyNamesContractResolver;
            }
            else
            {
                settings.ContractResolver = SharedADTOSharpContractResolver;
            }
        ...
        public static JsonSerializerOptions CreateJsonSerializerOptions(bool camelCase = false, bool indented = false)
        {
            ...
            }, _ =>
            {
                ...
                options.Converters.Add(new ADTOSharpStringToEnumFactory());
                options.Converters.Add(new ADTOSharpStringToBooleanConverter());
                options.Converters.Add(new ADTOSharpStringToGuidConverter());
                options.Converters.Add(new ADTOSharpNullableStringToGuidConverter());
                options.Converters.Add(new ADTOSharpNullableFromEmptyStringConverterFactory());
                options.Converters.Add(new ObjectToInferredTypesConverter());
                options.Converters.Add(new ADTOSharpJsonConverterForType());

                options.TypeInfoResolver = new ADTOSharpDateTimeJsonTypeInfoResolver();
