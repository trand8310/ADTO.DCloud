...
public abstract class ADTOSharpZeroCommonDbContext<TRole, TUser, TSelf> : ADTOSharpDbContext
    where TRole : ADTOSharpRole<TUser>
    where TUser : ADTOSharpUser<TUser>
    where TSelf : ADTOSharpZeroCommonDbContext<TRole, TUser, TSelf>
{
    /// <summary>
    /// Roles.
    /// </summary>
    ...
    /// </summary>
    protected ADTOSharpZeroCommonDbContext()
    {
    }
    ...
    protected ADTOSharpZeroCommonDbContext(string nameOrConnectionString)
        : base(nameOrConnectionString)
    {
    }

    protected ADTOSharpZeroCommonDbContext(DbCompiledModel model)
        : base(model)
    {
    }
    ...
    /// </summary>
    protected ADTOSharpZeroCommonDbContext(DbConnection existingConnection, bool contextOwnsConnection)
        : base(existingConnection, contextOwnsConnection)
    {
    }

    protected ADTOSharpZeroCommonDbContext(string nameOrConnectionString, DbCompiledModel model)
        : base(nameOrConnectionString, model)
    {
    }

    protected ADTOSharpZeroCommonDbContext(ObjectContext objectContext, bool dbContextOwnsObjectContext)
    ...
    /// Constructor.
    /// </summary>
    protected ADTOSharpZeroCommonDbContext(DbConnection existingConnection, DbCompiledModel model, bool contextOwnsConnection)
