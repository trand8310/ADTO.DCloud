...
/// <summary>
/// Base DbContext for ADTO zero.
/// Derive your DbContext from this class to have base entities.
/// </summary>
public abstract class ADTOSharpZeroDbContext<TTenant, TRole, TUser, TSelf> : ADTOSharpZeroCommonDbContext<TRole, TUser, TSelf>
    where TTenant : ADTOSharpTenant<TUser>
    where TRole : ADTOSharpRole<TUser>
    where TUser : ADTOSharpUser<TUser>
    where TSelf : ADTOSharpZeroDbContext<TTenant, TRole, TUser, TSelf>
{
    /// <summary>
    /// Tenants
    /// </summary>
    ...
    protected ADTOSharpZeroDbContext()
    {

    }

    protected ADTOSharpZeroDbContext(string nameOrConnectionString)
        : base(nameOrConnectionString)
    {

    }

    protected ADTOSharpZeroDbContext(DbCompiledModel model)
        : base(model)
    {

    }

    protected ADTOSharpZeroDbContext(DbConnection existingConnection, bool contextOwnsConnection)
        : base(existingConnection, contextOwnsConnection)
    {

    }

    protected ADTOSharpZeroDbContext(string nameOrConnectionString, DbCompiledModel model)
        : base(nameOrConnectionString, model)
    {
    }

    protected ADTOSharpZeroDbContext(ObjectContext objectContext, bool dbContextOwnsObjectContext)
        : base(objectContext, dbContextOwnsObjectContext)
    {
    }

    protected ADTOSharpZeroDbContext(DbConnection existingConnection, DbCompiledModel model, bool contextOwnsConnection)
