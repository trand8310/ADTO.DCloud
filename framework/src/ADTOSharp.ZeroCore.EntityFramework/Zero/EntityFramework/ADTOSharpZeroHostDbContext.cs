...
using ADTOSharp.EntityFramework.Extensions;
using ADTOSharp.Webhooks;

namespace ADTOSharp.Zero.EntityFramework;

[MultiTenancySide(MultiTenancySides.Host)]
public abstract class ADTOSharpZeroHostDbContext<TTenant, TRole, TUser, TSelf> : ADTOSharpZeroCommonDbContext<TRole, TUser, TSelf>
    where TTenant : ADTOSharpTenant<TUser>
    where TRole : ADTOSharpRole<TUser>
    where TUser : ADTOSharpUser<TUser>
    where TSelf : ADTOSharpZeroHostDbContext<TTenant, TRole, TUser, TSelf>
{
    /// <summary>
    /// Tenants
    /// </summary>
    ...
    protected ADTOSharpZeroHostDbContext()
    {

    }

    protected ADTOSharpZeroHostDbContext(string nameOrConnectionString)
        : base(nameOrConnectionString)
    {

    }

    protected ADTOSharpZeroHostDbContext(DbCompiledModel model)
        : base(model)
    {

    }

    protected ADTOSharpZeroHostDbContext(DbConnection existingConnection, bool contextOwnsConnection)
        : base(existingConnection, contextOwnsConnection)
    {

    }

    protected ADTOSharpZeroHostDbContext(string nameOrConnectionString, DbCompiledModel model)
        : base(nameOrConnectionString, model)
    {
    }

    protected ADTOSharpZeroHostDbContext(ObjectContext objectContext, bool dbContextOwnsObjectContext)
        : base(objectContext, dbContextOwnsObjectContext)
    {
    }

    protected ADTOSharpZeroHostDbContext(DbConnection existingConnection, DbCompiledModel model, bool contextOwnsConnection)
