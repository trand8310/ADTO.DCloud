...
/// <para>
/// ICache objects requested from <see cref="IADTOSharpPerRequestRedisCacheManager"/> stores redis caches per http context. And it does not try to pull it again from redis during the http context.
...
/// </summary>
public interface IADTOSharpPerRequestRedisCacheManager : ICacheManager
{
}