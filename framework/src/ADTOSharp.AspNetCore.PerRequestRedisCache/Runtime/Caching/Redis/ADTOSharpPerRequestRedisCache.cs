...
public class ADTOSharpPerRequestRedisCache : ADTOSharpRedisCache, IADTOSharpPerRequestRedisCache
{
    private const string ADTOSharpPerRequestRedisCachePrefix = "ADTOSharpPerRequestRedisCache:";

    private readonly IHttpContextAccessor _httpContextAccessor;

    public ADTOSharpPerRequestRedisCache(
        string name,
        IADTOSharpRedisCacheDatabaseProvider redisCacheDatabaseProvider,
        IRedisCacheSerializer redisCacheSerializer,
        IHttpContextAccessor httpContextAccessor,
        IMultiTenancyConfig multiTenancyConfig,
        IADTOSharpRedisCacheKeyNormalizer adtoRedisCacheKeyNormalizer)
        : base(name, redisCacheDatabaseProvider, redisCacheSerializer, adtoRedisCacheKeyNormalizer, multiTenancyConfig)
    {
    ...
    {
        return ADTOSharpPerRequestRedisCachePrefix + NormalizeKey(key).ToString();
    }
}