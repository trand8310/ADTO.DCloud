...
namespace ADTOSharp.AspNetCore.Mvc.Views;

/// <summary>
/// Base class for all views in ADTOSharp system.
/// </summary>
/// <typeparam name="TModel">Type of the View Model</typeparam>
public abstract class ADTOSharpRazorPage<TModel> : RazorPage<TModel>
{
    /// <summary>
