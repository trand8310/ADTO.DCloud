...
using ADTOSharp.AspNetCore.Mvc.Proxying.Utils;
...
public class AspNetCoreApiDescriptionModelProvider : IApiDescriptionModelProvider, ISingletonDependency
{
    ...
    private readonly ADTOSharpAspNetCoreConfiguration _configuration;
    ...
    public AspNetCoreApiDescriptionModelProvider(
        ...
        ADTOSharpAspNetCoreConfiguration configuration,
    ...
    private string GetModuleName(ApiDescription apiDescription)
    {
        ...
        {
            return ADTOSharpControllerAssemblySetting.DefaultServiceModuleName;
        }
