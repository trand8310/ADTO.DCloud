...
public class ADTOSharpValidateAntiforgeryTokenAuthorizationFilter : IAsyncAuthorizationFilter, IAntiforgeryPolicy
{
    ...
    public ADTOSharpValidateAntiforgeryTokenAuthorizationFilter(
