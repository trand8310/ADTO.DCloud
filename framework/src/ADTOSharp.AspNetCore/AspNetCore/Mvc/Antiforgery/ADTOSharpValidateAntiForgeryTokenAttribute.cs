...
public class ADTOSharpValidateAntiForgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter
{
    /// <summary>
    ...
    {
        return serviceProvider.GetRequiredService<ADTOSharpValidateAntiforgeryTokenAuthorizationFilter>();
    }
}