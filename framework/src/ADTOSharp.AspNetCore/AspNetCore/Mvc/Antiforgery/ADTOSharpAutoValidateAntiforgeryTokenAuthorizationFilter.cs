...
namespace ADTOSharp.AspNetCore.Mvc.Antiforgery;

public class ADTOSharpAutoValidateAntiforgeryTokenAuthorizationFilter : ADTOSharpValidateAntiforgeryTokenAuthorizationFilter, ITransientDependency
{
    ...
    private readonly IADTOSharpAntiForgeryConfiguration _antiForgeryConfiguration;

    public ADTOSharpAutoValidateAntiforgeryTokenAuthorizationFilter(
        IAntiforgery antiforgery,
        IOptions<AntiforgeryOptions> antiforgeryOptions,
        IADTOSharpAntiForgeryConfiguration antiForgeryConfiguration,
