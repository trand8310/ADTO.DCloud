...
/// </summary>
public class ADTOSharpLocalizationHeaderRequestCultureProvider : RequestCultureProvider
{
    ...
    public ADTOSharpLocalizationHeaderRequestCultureProvider()
    {
    ...
    public override Task<ProviderCultureResult> DetermineProviderCultureResult(HttpContext httpContext)
    {
        ...
        Logger.DebugFormat("{0} - Using Culture:{1} , UICulture:{2}", nameof(ADTOSharpLocalizationHeaderRequestCultureProvider), culture, uiCulture);
