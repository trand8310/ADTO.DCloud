...
public class ADTOSharpControllerAssemblySetting
{
    /// <summary>
    /// "app".
    /// </summary>
    ...
    public ADTOSharpControllerAssemblySetting(string moduleName, Assembly assembly, bool useConventionalHttpVerbs)
    {
