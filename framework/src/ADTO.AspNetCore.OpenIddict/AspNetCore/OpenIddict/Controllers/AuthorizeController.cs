...
using ADTO.AspNetCore.OpenIddict.ViewModels.Authorize;
...
public class AuthorizeController<TTenant, TRole, TUser> : ADTOOpenIdDictControllerBase<TTenant, TRole, TUser>
