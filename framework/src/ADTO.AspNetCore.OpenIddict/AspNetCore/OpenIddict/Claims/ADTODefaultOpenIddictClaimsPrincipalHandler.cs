...
public class ADTODefaultOpenIddictClaimsPrincipalHandler : IADTOOpenIddictClaimsPrincipalHandler, ITransientDependency
{
    public virtual Task HandleAsync(ADTOOpenIddictClaimsPrincipalHandlerContext context)
    {
        ...
        {
            if (claim.Type == ADTOSharpClaimTypes.TenantId)
            {
    ...
    protected virtual void AddSubClaim(ADTOOpenIddictClaimsPrincipalHandlerContext context)
    {
