...
public static class AutoMapExtensions
{
    ...
    {
        return ADTOSharpEmulateAutoMapper.Mapper != null ? ADTOSharpEmulateAutoMapper.Mapper.Map<TDestination>(source) : default(TDestination);
    }
    ...
    {
        return ADTOSharpEmulateAutoMapper.Mapper != null ? ADTOSharpEmulateAutoMapper.Mapper.Map(source, destination) : default(TDestination);
    }
