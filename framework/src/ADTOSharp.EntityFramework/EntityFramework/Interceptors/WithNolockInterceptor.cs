...
namespace ADTOSharp.EntityFramework.Interceptors
{
    public class WithNoLockInterceptor : DbCommandInterceptor, ITransientDependency
    {
        private const string InterceptionContextKey = "ADTOSharp.EntityFramework.Interceptors.WithNolockInterceptor";
