...
namespace ADTOSharp.EntityFramework.Repositories
{
    ...
    public class EfRepositoryBase<TDbContext, TEntity, TPrimaryKey> : ADTOSharpRepositoryBase<TEntity, TPrimaryKey>, IRepositoryWithDbContext, ISupportsExplicitLoading<TEntity, TPrimaryKey>
        ...
        where TDbContext : DbContext
    {
            ...
            CancellationToken cancellationToken) where TProperty : class
        {
            ...
            if (expression == null)
            {
                throw new ADTOSharpException($"Given {nameof(collectionExpression)} is not a {typeof(MemberExpression).FullName}");
            }
