...
using ADTOSharp.EntityFramework.Utils;
...
namespace ADTOSharp.EntityFramework
{
    ...
    /// </summary>
    public abstract class ADTOSharpDbContext : DbContext, ITransientDependency, IShouldInitialize, IShouldInitializeDcontext
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor.
        /// Uses <see cref="IADTOSharpStartupConfiguration.DefaultNameOrConnectionString"/> as connection string.
        /// </summary>
        protected ADTOSharpDbContext()
        {
            InitializeDbContext();
        }
        ...
        /// Constructor.
        /// </summary>
        protected ADTOSharpDbContext(string nameOrConnectionString)
        ...
        /// Constructor.
        /// </summary>
        protected ADTOSharpDbContext(DbCompiledModel model)
            : base(model)
        {
            InitializeDbContext();
        }
        ...
        /// Constructor.
        /// </summary>
        protected ADTOSharpDbContext(DbConnection existingConnection, bool contextOwnsConnection)
        ...
        /// Constructor.
        /// </summary>
        protected ADTOSharpDbContext(string nameOrConnectionString, DbCompiledModel model)
        ...
        /// Constructor.
        /// </summary>
        protected ADTOSharpDbContext(ObjectContext objectContext, bool dbContextOwnsObjectContext)
        ...
        /// Constructor.
        /// </summary>
        protected ADTOSharpDbContext(DbConnection existingConnection, DbCompiledModel model, bool contextOwnsConnection)
        ...
        public virtual void Initialize()
        {
            ...
            this.SetFilterScopedParameterValue(ADTOSharpDataFilters.MustHaveTenant, ADTOSharpDataFilters.Parameters.TenantId,
                ADTOSharpSession.TenantId ?? 0);
            this.SetFilterScopedParameterValue(ADTOSharpDataFilters.MayHaveTenant, ADTOSharpDataFilters.Parameters.TenantId,
        ...
        {
            modelBuilder.Filter(ADTOSharpDataFilters.SoftDelete, (ISoftDelete d) => d.IsDeleted, false);
            modelBuilder.Filter(ADTOSharpDataFilters.MustHaveTenant,
...
#pragma warning restore CS0472 // While "(int?)t.TenantId == null" seems wrong, it's needed. See https://github.com/jcachat/EntityFramework.DynamicFilters/issues/62#issuecomment-208198058
                0); 
            modelBuilder.Filter(ADTOSharpDataFilters.MayHaveTenant,
        ...
        public override int SaveChanges()
        {
            try
            {
                var changedEntities = ApplyADTOSharpConcepts();
        ...
        protected virtual void ApplyADTOSharpConcepts(DbEntityEntry entry, long? userId, EntityChangeReport changeReport)
        {
            switch (entry.State)
            {
                case EntityState.Added:
        ...
        protected virtual void ApplyADTOSharpConceptsForAddedEntity(DbEntityEntry entry, long? userId,
        ...
        protected virtual void ApplyADTOSharpConceptsForModifiedEntity(DbEntityEntry entry, long? userId,
            EntityChangeReport changeReport)
        {
        ...
        protected virtual void ApplyADTOSharpConceptsForDeletedEntity(DbEntityEntry entry, long? userId,
            EntityChangeReport changeReport)
        {
        ...
        protected virtual void CheckAndSetMayHaveTenantIdProperty(object entityAsObj)
        {
            ...
            if (!this.IsFilterEnabled(ADTOSharpDataFilters.MayHaveTenant))
            {
                return;
            }
